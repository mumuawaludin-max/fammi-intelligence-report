 ...
 * dari sc/scHooks.js.
 *
 * Dipakai khusus untuk batang data (PaBar/PaStackBar), BUKAN motion `whileInView` seperti
 * PaReveal. Alasannya satu: kalau animasi motion tidak pernah jalan (tab di latar belakang,
