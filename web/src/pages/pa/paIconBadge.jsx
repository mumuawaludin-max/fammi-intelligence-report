...
const ICON_MAP = {
  ...
  // Empat tingkat "sinyal pembacaan" jawaban esai (lihat deteksiTonSinyal di PaRuangBacaEsai.jsx)
  sinyalPositif: Smiley,
  sinyalRingan: SmileyMeh,
  sinyalPantau: Eye,
  sinyalPrioritas: Warning,
  lightbulb: Lightbulb,
