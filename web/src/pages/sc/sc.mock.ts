...
export const MOCK_LAPORAN_AGREGAT_SC: LaporanAgregatSC = {
  ...
  analisis: {
    ...
    // angka yang sama, tanpa round-trip pembulatan. label_item mengikuti bentuk berkas asli:
    // tiap pasangan dimensi x tipe punya redaksi butir sendiri (dipakai 03-B), bukan empat
    // kalimat yang sama diulang enam kali.
    heatmap: [
      { dimensi: "Karakter Lembaga", tipe: "Kekeluargaan", nilai: 89, nilai_mentah: 4.44, label_item: "Seperti keluarga besar" },
      { dimensi: "Kepemimpinan", tipe: "Kekeluargaan", nilai: 80, nilai_mentah: 4.0, label_item: "Pimpinan seperti orang tua" },
      { dimensi: "Manajemen", tipe: "Kekeluargaan", nilai: 76, nilai_mentah: 3.81, label_item: "Gaya kerja kekeluargaan" },
      { dimensi: "Sinergi Tim", tipe: "Kekeluargaan", nilai: 80, nilai_mentah: 4.0, label_item: "Perekat rasa saling percaya" },
      { dimensi: "Fokus Strategis", tipe: "Kekeluargaan", nilai: 81, nilai_mentah: 4.06, label_item: "Menekankan kepedulian antaranggota" },
      { dimensi: "Kinerja/Performa", tipe: "Kekeluargaan", nilai: 75, nilai_mentah: 3.75, label_item: "Sukses diukur dari kekompakan" },
      { dimensi: "Karakter Lembaga", tipe: "Inovasi", nilai: 72, nilai_mentah: 3.6, label_item: "Berani mencoba hal baru" },
      { dimensi: "Kepemimpinan", tipe: "Inovasi", nilai: 76, nilai_mentah: 3.8, label_item: "Pimpinan mendorong ide baru" },
      { dimensi: "Manajemen", tipe: "Inovasi", nilai: 66, nilai_mentah: 3.3, label_item: "Gaya kerja memberi ruang coba" },
      { dimensi: "Sinergi Tim", tipe: "Inovasi", nilai: 70, nilai_mentah: 3.5, label_item: "Perekat semangat pembaruan" },
      { dimensi: "Fokus Strategis", tipe: "Inovasi", nilai: 78, nilai_mentah: 3.9, label_item: "Menekankan pengembangan cara baru" },
      { dimensi: "Kinerja/Performa", tipe: "Inovasi", nilai: 68, nilai_mentah: 3.4, label_item: "Sukses diukur dari terobosan" },
      { dimensi: "Karakter Lembaga", tipe: "Orientasi", nilai: 78, nilai_mentah: 3.9, label_item: "Fokus pada pencapaian" },
      { dimensi: "Kepemimpinan", tipe: "Orientasi", nilai: 72, nilai_mentah: 3.6, label_item: "Pimpinan menuntut hasil" },
      { dimensi: "Manajemen", tipe: "Orientasi", nilai: 74, nilai_mentah: 3.7, label_item: "Gaya kerja mengejar target" },
      { dimensi: "Sinergi Tim", tipe: "Orientasi", nilai: 64, nilai_mentah: 3.2, label_item: "Perekat target bersama" },
      { dimensi: "Fokus Strategis", tipe: "Orientasi", nilai: 82, nilai_mentah: 4.1, label_item: "Menekankan capaian terukur" },
      { dimensi: "Kinerja/Performa", tipe: "Orientasi", nilai: 76, nilai_mentah: 3.8, label_item: "Sukses diukur dari hasil akhir" },
      { dimensi: "Karakter Lembaga", tipe: "Aturan", nilai: 82, nilai_mentah: 4.1, label_item: "Tertib dan terstruktur" },
      { dimensi: "Kepemimpinan", tipe: "Aturan", nilai: 68, nilai_mentah: 3.4, label_item: "Pimpinan menjaga prosedur" },
      { dimensi: "Manajemen", tipe: "Aturan", nilai: 84, nilai_mentah: 4.2, label_item: "Gaya kerja ikut aturan baku" },
      { dimensi: "Sinergi Tim", tipe: "Aturan", nilai: 62, nilai_mentah: 3.1, label_item: "Perekat aturan yang sama" },
      { dimensi: "Fokus Strategis", tipe: "Aturan", nilai: 72, nilai_mentah: 3.6, label_item: "Menekankan kestabilan kerja" },
      { dimensi: "Kinerja/Performa", tipe: "Aturan", nilai: 78, nilai_mentah: 3.9, label_item: "Sukses diukur dari ketertiban" },
    ],
