...
export const MOCK_LAPORAN_AGREGAT_CW: LaporanAgregatCW = {
  ...
  analisis: {
    heatmap: [
      { dimensi: "Karakter Lembaga", tipe: "Kekeluargaan", nilai_mentah: 3.4 },
      { dimensi: "Karakter Lembaga", tipe: "Inovasi", nilai_mentah: 2.3 },
      { dimensi: "Karakter Lembaga", tipe: "Orientasi", nilai_mentah: 2.7 },
      { dimensi: "Karakter Lembaga", tipe: "Aturan", nilai_mentah: 3.1 },
      { dimensi: "Kepemimpinan", tipe: "Kekeluargaan", nilai_mentah: 3.6 },
      { dimensi: "Kepemimpinan", tipe: "Inovasi", nilai_mentah: 2.5 },
      { dimensi: "Kepemimpinan", tipe: "Orientasi", nilai_mentah: 2.9 },
      { dimensi: "Kepemimpinan", tipe: "Aturan", nilai_mentah: 3.3 },
      { dimensi: "Manajemen", tipe: "Kekeluargaan", nilai_mentah: 2.9 },
      { dimensi: "Manajemen", tipe: "Inovasi", nilai_mentah: 2.1 },
      { dimensi: "Manajemen", tipe: "Orientasi", nilai_mentah: 2.6 },
      { dimensi: "Manajemen", tipe: "Aturan", nilai_mentah: 3.5 },
      { dimensi: "Sinergi Tim", tipe: "Kekeluargaan", nilai_mentah: 3.8 },
      { dimensi: "Sinergi Tim", tipe: "Inovasi", nilai_mentah: 2.6 },
      { dimensi: "Sinergi Tim", tipe: "Orientasi", nilai_mentah: 2.8 },
      { dimensi: "Sinergi Tim", tipe: "Aturan", nilai_mentah: 3.0 },
      { dimensi: "Fokus Strategis", tipe: "Kekeluargaan", nilai_mentah: 3.1 },
      { dimensi: "Fokus Strategis", tipe: "Inovasi", nilai_mentah: 2.4 },
      { dimensi: "Fokus Strategis", tipe: "Orientasi", nilai_mentah: 3.2 },
      { dimensi: "Fokus Strategis", tipe: "Aturan", nilai_mentah: 2.9 },
      { dimensi: "Kinerja/Performa", tipe: "Kekeluargaan", nilai_mentah: 3.0 },
      { dimensi: "Kinerja/Performa", tipe: "Inovasi", nilai_mentah: 2.2 },
      { dimensi: "Kinerja/Performa", tipe: "Orientasi", nilai_mentah: 3.4 },
      { dimensi: "Kinerja/Performa", tipe: "Aturan", nilai_mentah: 2.8 },
    ],
  },
